  ...
  <div class="col-10">
    <form method="POST">
      <div class="mb-3">
        ...
        <input type="text" name='contract_number' class="form-control" id="exampleInputEmail1"
          aria-describedby="emailHelp">
      </div>
      <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Дата договора</label>
        <input type="date" name='contract_date' class="form-control" id="exampleInputEmail1"
          aria-describedby="emailHelp">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" name='payment_terms' class="form-control" id="exampleInputEmail1"
          aria-describedby="emailHelp">
      </div>
      <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label">Условия поставки</label>
        <input type="text" name='delivery_terms' class="form-control" id="exampleInputEmail1"
          aria-describedby="emailHelp">
      </div>
